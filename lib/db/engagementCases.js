...
export async function createCase(data, userId) {
  const { accountId, title, channel, objective, description, assignedToId, openedAt, outageId, dueDate, reminderHoursBefore } = data
  return prisma.engagementCase.create({
    data: {
      ...
      reminderHoursBefore: reminderHoursBefore ? Number(reminderHoursBefore) : null,
    },
    include: INCLUDE_FULL,
  })
}
...
export async function updateCase(id, data) {
  const { accountId, title, channel, objective, description, assignedToId, outageId, dueDate, reminderHoursBefore } = data
  return prisma.engagementCase.update({
    ...
    data: {
      ...
      ...(reminderHoursBefore  !== undefined && { reminderHoursBefore: reminderHoursBefore ? Number(reminderHoursBefore) : null }),
    },
    include: INCLUDE_FULL,
  })
}
