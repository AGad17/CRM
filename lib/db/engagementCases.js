...
export async function createCase(data, userId) {
  const { accountId, title, channel, objective, description, assignedToId, openedAt } = data
...
export async function updateCase(id, data) {
  const { title, channel, objective, description, assignedToId } = data
...
export async function createOutage(data, userId) {
  const { title, channel, description } = data
  return prisma.engagementCase.create({
    data: {
      openedById:   userId,
      title,
