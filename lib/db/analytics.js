...
async function getAllContracts(filters = {}) {
  ...
  if (filters.accountManagerId) accountWhere.onboarding = { accountManagerId: filters.accountManagerId }
...
async function getAllAccounts(filters = {}) {
  ...
  if (filters.accountManagerId) where.onboarding = { accountManagerId: filters.accountManagerId }
